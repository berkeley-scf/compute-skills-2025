...
- When you run `gh-scoped-creds` above, you'll see a [link](https://github.com/login/device){target="_blank"} and a code.
- Go to the link in a browser (on your laptop, outside of DataHub), login to GitHub (or click `Continue` if already logged in).
