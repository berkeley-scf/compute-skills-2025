...
First make a local copy of the repository from the remote on GitHub. It's best do this **outside** of the `compute-skills-2025` directory; otherwise you'll have a repository nested within a repository. 

```bash
## First `cd` to your home directory to
## avoid cloning into the `compute-skills-2025` repository.
...
Here are some options for opening an Editor to edit your code/markdown/text files.
 ...
 - If you go to your repository on GitHub, and click into a file and then press "." (the period key), GitHub will put you into a VS Code-based editor window.
...
Add your new code to your repository. Then commit it. You could push it to  GitHub if you want, but that will be part of a later exercise at the end of Section 3, so we'll troubleshoot problems with pushing then.
...
![operations in a repository (Credit: Research Software Engineering with Python, CC License)](git-remote.png "Visualization of operations with and parts of Git")
...
#### Step 0: Push your changes to GitHub so they're easily available to your partner.
